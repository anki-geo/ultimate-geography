...
A political entity can be included either fully (map, capital and flag) or partially (with only a map).
...
- Specifically inhabited dependent territories that are not also sovereign states.
...
- Specifically insular autonomous territories that are not also sovereign states or dependent territories.
...
- Specifically inhabited territories located on a different content than their mainland, and that are not also dependent territories.
...
- Specifically inhabited full or semi land enclaves/exclaves that are not also sovereign states or dependent territories.
- Relevant sections:
...
A physcial entity can only be included partially, with only a map.
